...
public class FenetreUI extends JFrame {
    ...
    private JMenu initMenuContacts() {
        ...
        /* menu Contacts */
        menuContacts[0] = new JMenuItem("Créer un nouveau contact");
        ...
        menuContacts[1] = new JMenuItem("Créer un nouveau groupe");
        ...
        menu.add(menuContacts[3]);
                ...
                menuContacts[4] = new JMenuItem("Ajouter un contact dans un groupe");
        ...
        menuContacts[5] = new JMenuItem("Supprimer un contact dans un groupe");
	...
	menuEvenements[0].addActionListener(new ActionListener(){
	    ...
	    @Override
	    public void actionPerformed(ActionEvent e) {controleur.creerEvenement();}
	});
